...
public class FibonacciHeap<T>
{
    ...
    {
       // System.out.println("decreaseKey"+x.toString()+"k="+k);
        if (k > x.key) {
    ...
    protected void consolidate()
    {
        ...
        while (numRoots > 0) {
            ...
            for (;;) {
                ...
                //Since y has been visited and at that time we have
                //decremented numRoots, we don't have to decrement it
                //now.
                link(y, x);
